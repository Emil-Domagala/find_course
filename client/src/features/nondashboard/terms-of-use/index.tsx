  ...
  return (
    <section className="container text-md mt-7 text-balance">
      <div className="mb-4 ">
        ...
        <p>By accessing or using this platform, you agree to be bound by these Terms of Use. If you do not agree, please do not use the service.</p>
      </div>
      <div className="mb-4">
        <h2 className={h2Class}>1. Demo Platform</h2>
        <p>
          This application is for demonstration purposes only. It does not offer real products or services. Any content, courses, or transactions are fictional
          and for testing or presentation only.
        </p>
      </div>
      ...
      <div className="mb-4">
        ...
        <p>Accounts you create may be deleted at any time without notice. Cart and user data are temporary and reset weekly.</p>
      </div>

      <div className="mb-4">
        <h2 className={h2Class}>4. Payments</h2>
        <p>
          Stripe is integrated into the platform for testing payment functionality. Any transactions made are not actual purchases and do not grant ownership or
      ...
      <div className="mb-4">
        ...
        <p>
          You retain ownership of the content you upload, but you grant us a non-exclusive right to use it within the application. We reserve the right to
          remove or modify content at our discretion.
        </p>
      </div>

      <div className="mb-4">
        <h2 className={h2Class}>6. No Warranty</h2>
        <p>The platform is provided &quot;as is&quot; with no warranties, guarantees, or promises of availability, reliability, or data persistence.</p>
      </div>
      <div className="mb-4">
