...
export const UserRegisterSchema = z.object({
  ...
  username: z.string().trim().min(3, { message: 'At least 3 characters long' }).max(30, { message: 'At most 30 characters long' }),
  userLastname: z.string().trim().min(2, { message: 'At least 2 characters long' }).max(30, { message: 'At most 30 characters long' }),
