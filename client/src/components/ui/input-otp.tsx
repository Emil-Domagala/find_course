  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        ref={ref}
        className={cn(
          'relative text-md flex h-9 w-9 items-center justify-center border-y border-r border-input shadow-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md',
          isActive && 'z-10 ring-1 ring-primary-600 border-primary-600',
          className,
        )}
        {...props}>
        {char}
