        ...
        <div className="mb-6 !border-none">
          <div className="h-[50vh] flex justify-center items-center p-0 m-0">
            {chapterData.type === ChapterType.VIDEO ? (
              <ReactVideo courseId={courseId as string} nextChapterId={nextChapterId} chapterId={chapterId as string} chapterData={chapterData} handleUpdateChapterProgress={handleUpdateChapterProgress} currentProgressChapter={currentProgressChapter} />
            ) : (
