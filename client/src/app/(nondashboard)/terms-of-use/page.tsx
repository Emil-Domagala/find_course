  ...
  return (
    <section className="container text-md mt-7 text-balance">
      ...
      <div className="mb-4">
        ...
        <p>
          This application is for demonstration purposes only. It does not offer real products or services. Any content, courses, or transactions are fictional and for testing or
          presentation only.
        </p>
      </div>
      ...
      <div className="mb-4">
        ...
        <p>
          Stripe is integrated into the platform for testing payment functionality. Any transactions made are not actual purchases and do not grant ownership or access to real
          services.
        </p>
      </div>
      ...
      <div className="mb-4">
        ...
        <p>
          You retain ownership of the content you upload, but you grant us a non-exclusive right to use it within the application. We reserve the right to remove or modify content
          at our discretion.
        </p>
      </div>
