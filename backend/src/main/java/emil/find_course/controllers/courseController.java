...
public class CourseController {
    ...
    // User
    // 1) Showing all published courses in order to show them for sale.(Title, image, author)
    ...
    @PostMapping("/courses")
    public ResponseEntity<?> postCourse(Principal principal, @RequestBody RequestCourseBody requestCourseBody) {
