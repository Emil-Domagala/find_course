...
public class MvcConfig implements WebMvcConfigurer {
    ...
    private final Path imageUploadDir = Paths.get(storageLocation).toAbsolutePath();
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        log.info("Configuring resource handler for /uploads/images/** mapping to {}", resourceLocation);
